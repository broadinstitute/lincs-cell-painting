...
def get_args():
    ...
    parser.add_argument('-f', '--barcode_platemap_file', help='path of plate info')
    parser.add_argument('-m', '--moa_file', help='path of moa/target data storing')
    parser.add_argument('-j', '--project_name', help='string for the project name')
    parser.add_argument('-o', '--output_dir', default=pathlib.PurePath("data/profiles"),
                        help='the directory to output the files')

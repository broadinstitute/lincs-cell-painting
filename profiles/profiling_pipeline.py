...
profile_dir = pathlib.PurePath("/home/ubuntu/bucket/projects/", project, "workspace/backend")
...
moa_file = pathlib.PurePath("../metadata/moa/repurposing_info_external_moa_map_resolved.tsv")
moa_df = pd.read_csv(moa_file, sep='\t')
assert isinstance(moa_df, pd.DataFrame), "Error, MOA file does not exist. Is the path updated?"
